...
if __name__ == "__main__":
    ...
    while True:
            ...
            if 'wikipedia' in query:  #if wikipedia found in the query then this block will be executed
                ...
                speak("Playing sound")
                playsound('static\\sound effects\\sound of lion.wav')
                ...
                playsound.playsound("static\\sound effects\\grandpa.wav")
                ...
                playsound.playsound("static\\sound effects\\grandma.wav")
                ...
                playsound.playsound(r"static\sound clips\mixkit-light-applause-with-laughter-audience-512.wav")
                ...
                os.startfile(r"static\sound clips\mixkit-cartoon-voice-laugh-343.wav")
    
            elif "why you came to world" in query:
                speak("Thanks to Krishna. further It's a secret")
                os.startfile(r"static\sound clips\mixkit-conference-audience-clapping-strongly-476.wav")
